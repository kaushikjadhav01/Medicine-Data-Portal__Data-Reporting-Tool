...
def test_filing_get_with_data(client,make_partner_with_products_case1,make_countries):
...
def test_filing_get_without_data(client,make_partner_with_products_case2,make_countries):
...
def test_filing_get_with_data_admin(client,make_partner_with_products_case1,make_countries):
    ...
    response = client.get('/api/template/filing/' + str(partner_id) + '/')
